            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item active" aria-current="page"><a href=" {{ url('articles') }} ">Article List</a></li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
                  ...
                  <form method="post" action="{{ url('article-save') }}">
                    ...
                    <div class="card-body">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="name" name="article_title" class="form-control"  value="{{ old('article_title', $cateogry_detail->category_name ?? '') }}"  id="category_name" >
                      ...
                      <textarea class="form-control" name="description" id="description" aria-label="With textarea">{{ old('category_detail', $cateogry_detail->category_short_detail ?? '') }}</textarea>
                      </div>
                        ...
                        <span class="list_of_checkboxs" > 
                          @foreach($categories as $k=>$v)
                              ...
                              <div class="form-check">
                                  <input class="form-check-input " value="{{$k}}" type="checkbox" id="categories" name="categories[]"  >
